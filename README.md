...
Proyek ini di ciptakan sebagai projek pengganti Ujian Akhir Semester (UAS) Universitas Cokroaminoto Palopo mata kuliah 'Aplikasi Mobile II' pada tahun akademik 2026/2025
...
1. Otentikasi Firebase (Firebase Auth) dengan Metode :
✔️ Login & Register aman menggunakan Email/Password.
✔️ Login & Register aman mengunakan Akun Google
2. Implemetnasi Databse Firebase & CRUD (Create, Read, Update, Delete)
✔️ Create (Input): Menambahakn sebuah transaksi yang mengandung tanggal, jam, jumlah transaksi, serta deskripsi transaksi
...
✔️ RecyclerView/ListView: List tugas yang responsif yang menampilkan daftar transaksi berdasarkan tanggal.
